...
app = FastAPI(title="HKU ChatGPT Proxy", version="6.1.0", lifespan=lifespan)
    ...
    async with httpx.AsyncClient() as client:
        try:
            ...
            if resp.status_code == 401:
                ...
                if not new_token: raise HTTPException(status_code=401, detail="Auto token refresh failed.")
